...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2><i class="fa fa-product-hunt" aria-hidden="true"></i> Product Management</h2>
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="{{ route('admin.dashboard') }}">Home</a>
			</li>
			<li class="breadcrumb-item active">
				<span class="label label-success float-right all_backgroud"><strong>Product Table</strong></span>
			</li>
		</ol>
	</div>
</div>
			...
			<div class="ibox">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn them" href="{{route('admin.product.create')}}">
							<i class="icon-plus fa-fw"></i>Add Product</a>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title pull-left" id="exampleModalLabel1">Product Detail</h5>
...
$(document).on("click",".changeStatusRecord",function(e){
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{ route('admin.product.change_status','replaceid') }}",
					type: 'post',
					data: {"_method": 'post',
						'id':id,
						"_token": "{{ csrf_token() }}"
				...
				swal("Cancelled", "Your Product Status is safe :)", "error");
			}
		});
		return false;
	})
