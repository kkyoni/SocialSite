        ...
        <div class="col-md-6">
            ...
            <div class="ibox">
                ...
                <div class="ibox-content" id="imagePreview">
                   ...
                   <img src="{!!  \Auth::user()->avatar !== '' ? url("storage/avatar/".\Auth::user()->avatar) : url('storage/default.png') !!}" alt="user-img" class="img-circle" style="margin:0 auto">
                   @else
                   <!-- <i class="fa fa-pencil fa-2x"></i> -->
                   <img src="{!! url('storage/avatar/default.png') !!}" name="avatar" alt="user-img" class="img-circle" accept="image/*" style="margin:0 auto">
                   @endif
                   <br>
                   <span >
