...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2><i class="fa fa-star" aria-hidden="true"></i> Blog Management</h2>
		<ol class="breadcrumb">
			...
			<div class="ibox">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn them" href="{{route('admin.blog.create')}}">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title pull-left" id="exampleModalLabel1">Blog Detail</h5>
...
$(document).on("click",".changeStatusRecord",function(e){
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{ route('admin.blog.change_status','replaceid') }}",
					type: 'post',
					data: {"_method": 'post',
						'id':id,
						"_token": "{{ csrf_token() }}"
				...
				swal("Cancelled", "Your Blog Status is safe :)", "error");
			}
		});
		return false;
	})
